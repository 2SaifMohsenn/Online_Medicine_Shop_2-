...
const products = [
  { id: '1', name: 'Vitamin C', price: '80 EGP', stock: 25, img: require('@/assets/images/vitamin_C.png') },
  { id: '2', name: 'Vitamin D', price: '70 EGP', stock: 12, img: require('@/assets/images/vitamin_C.png') },
  { id: '3', name: 'Multivitamins', price: '120 EGP', stock: 0, img: require('@/assets/images/vitamin_C.png') },
  { id: '4', name: 'Vitamin B12', price: '60 EGP', stock: 8, img: require('@/assets/images/vitamin_C.png') },
];
...
const styles = StyleSheet.create({
  ...
  image: { width: '100%', height: 110, resizeMode: 'contain', marginBottom: 12 },
