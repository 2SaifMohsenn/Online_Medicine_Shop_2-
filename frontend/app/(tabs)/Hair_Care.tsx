...
const products = [
  { id: '1', name: 'Hair Serum', price: '90 EGP', stock: 10, img: require('@/assets/images/shampoo.jpg') },
  { id: '2', name: 'Shampoo', price: '75 EGP', stock: 15, img: require('@/assets/images/shampoo.jpg') },
  { id: '3', name: 'Hair Conditioner', price: '80 EGP', stock: 5, img: require('@/assets/images/shampoo.jpg') },
  { id: '4', name: 'Hair Oil', price: '60 EGP', stock: 0, img: require('@/assets/images/shampoo.jpg') },
];
