...
const products = [
  { id: '1', name: 'Cold Relief', price: '60 EGP', stock: 8, img: require('@/assets/images/Panadol.png') },
  { id: '2', name: 'Flu Medicine', price: '75 EGP', stock: 5, img: require('@/assets/images/Panadol.png') },
  { id: '3', name: 'Cough Syrup', price: '50 EGP', stock: 0, img: require('@/assets/images/Panadol.png') },
  { id: '4', name: 'Day & Night Combo', price: '90 EGP', stock: 12, img: require('@/assets/images/Panadol.png') },
];
